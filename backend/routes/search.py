...
def search():
    ...
    try:
        ...
        return jsonify({'error': 'Database query failed', 'movies': [], 'persons': [], 'total': 0}), 503
...
def filter_movies():
    ...
    try:
        ...
        return jsonify({'error': 'Database query failed', 'movies': [], 'total': 0}), 503
...
def list_genres():
    ...
    try:
        ...
        logger.error(f"Genres query failed: {e}")
        return jsonify([]), 503
...
def list_countries():
    ...
    try:
        ...
        logger.error(f"Countries query failed: {e}")
        return jsonify([]), 503
